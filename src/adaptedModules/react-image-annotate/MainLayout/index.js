...
export var MainLayout = function MainLayout(_ref2) {
  ...
  var canvas = /*#__PURE__*/React.createElement(ImageCanvas, Object.assign({}, settings, {
    ...
    onDeleteRegion: (e) => {if (_ref2.onDeleteRegion) {_ref2.onDeleteRegion(e)} ; action("DELETE_REGION", "region")},
    ...
    onSelectRegion: (e) => {if (_ref2.onSelectRegion) {_ref2.onSelectRegion(e)} ; action("SELECT_REGION", "region")},
